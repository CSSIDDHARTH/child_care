...
export default function TherapyApproach() {
  ...
  return (
    <section className="py-20 md:py-28 bg-gradient-to-br from-[#E6F7E6] via-[#EDF9ED] to-[#F2FBF2] overflow-hidden relative">
      {/* Decorative background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-brand-blue/8 rounded-full blur-3xl -z-10"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white border border-slate-200 rounded-lg p-6 md:p-8 shadow-sm">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-lg font-medium font-display text-[#008DD2]">Interdisciplinary Alignment</h3>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed">
                By integrating <span className="text-[#008DD2] font-semibold">Speech Therapy</span>, <span className="text-[#008DD2] font-semibold">Occupational Therapy &amp; Sensory Integration</span>, <span className="text-[#008DD2] font-semibold">Special Education</span>, <span className="text-[#008DD2] font-semibold">Behavior Therapy / ABA Therapy</span>, <span className="text-[#008DD2] font-semibold">Developmental Assessment &amp; Psychological Testing</span>, and <span className="text-[#008DD2] font-semibold">Parent Counseling &amp; Family Support</span> under a unified clinical framework, our clinicians address all aspects of development in synergy.
              </p>
            </div>
            ...
            <div className="bg-white border border-slate-200 rounded-lg p-6 md:p-8 shadow-sm">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-lg font-medium font-display text-[#008DD2]">Standardized Evaluations</h3>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {approaches.map((app, index) => (
                <motion.div
                  ...
                  className="bg-white border border-slate-200 rounded-lg p-6 hover:bg-[#F7FBFE] hover:border-brand-blue/30 transition-all group shadow-sm"
                >
                  <div className="flex items-center space-x-2 mb-3">
                    <div className="w-0.5 h-5 bg-brand-blue"></div>
                    <h5 className="font-display font-medium text-base text-slate-800 group-hover:text-brand-blue transition-colors">
                      {app.title}
                    </h5>
                  </div>
            ...
            <div className="pt-6 border-t border-slate-200 flex items-center space-x-4">
              ...
              <p className="quote-handwriting text-base md:text-lg">
